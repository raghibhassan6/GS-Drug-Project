...
public class PUpdate extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(55, 183, 185));
        ...
        jButton5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Other_files/outgoing.png"))); // NOI18N
        jButton5.setText("Outgoing Products");
        ...
        jButton6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Other_files/project.png"))); // NOI18N
        jButton6.setText("Incoming Products");
        ...
        jLabel2.setText("Product Updates");
        ...
        jLabel1.setText("Incoming Product");
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel2Layout.createSequentialGroup()
                                        ...
                                        .addComponent(pt, javax.swing.GroupLayout.PREFERRED_SIZE, 252, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(pn, javax.swing.GroupLayout.PREFERRED_SIZE, 45, javax.swing.GroupLayout.PREFERRED_SIZE))))
                        .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(58, 58, 58)
        ...
        jPanel2Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {delete, jButton3});
        ...
        jLabel5.setText("Outgoing Product");
        ...
        pt1.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(pt1, javax.swing.GroupLayout.PREFERRED_SIZE, 235, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(28, 28, 28)
        ...
        jPanel3Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {add1, delete1});
    ...
    private void addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionPerformed
        ...
        javax.swing.table.DefaultTableModel dtm = (javax.swing.table.DefaultTableModel) t7.getModel();
...
//              r.add(date);
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        ...
        DefaultTableModel del = (DefaultTableModel) t7.getModel();
        if (t7.getSelectedRow() != -1) {
            // remove selected row from the model
            del.removeRow(t7.getSelectedRow());
        }
...
//            javax.swing.table.DefaultTableModel dtm
        javax.swing.table.DefaultTableModel dtm
                = (javax.swing.table.DefaultTableModel) t7.getModel();

        int x;
        int ri = dtm.getRowCount();
        for (int i = 0; i < ri; i++) {

            int pnew = Integer.parseInt((String) t7.getValueAt(i, 1));
            String proname = (String) t7.getValueAt(i, 0);

            System.out.println("name" + proname);
            System.out.println("value" + pnew);

            try {
                Databases.dbconnect.checkProName.setString(1, proname);
                ResultSet rs = Databases.dbconnect.checkProName.executeQuery();
                if (rs.next()) {
                    System.out.println("Value exists" + pnew);
                    Databases.dbconnect.updateproduct.setInt(1, rs.getInt("NUMBERS") + pnew);
                    Databases.dbconnect.updateproduct.setString(2, proname);
                    Databases.dbconnect.updateproduct.executeUpdate();
                } else {

                    Databases.dbconnect.newproduct.setString(1, proname);

                    Databases.dbconnect.newproduct.setInt(2, pnew);

                    x = Databases.dbconnect.newproduct.executeUpdate();
                   
                    if(x!=1){
                        JOptionPane.showMessageDialog(null, "Error in product insertion");
                    }
                }
            } catch (Exception ex) {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        DefaultTableModel model = (DefaultTableModel) t7.getModel();
        model.setRowCount(0);
    ...
    private void add1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_add1ActionPerformed
        ...
        String name1 = pt1.getText();
        String pno1 = pn1.getText();

        javax.swing.table.DefaultTableModel dtm = (javax.swing.table.DefaultTableModel) t8.getModel();
...
//              r.add(date);
    ...
    private void delete1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_delete1ActionPerformed
        // TODO add your handling code here:
        DefaultTableModel del = (DefaultTableModel) t8.getModel();
        if (t8.getSelectedRow() != -1) {
            // remove selected row from the model
            del.removeRow(t8.getSelectedRow());
        }
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        // TODO add your handling code here:
        javax.swing.table.DefaultTableModel dtm
                = (javax.swing.table.DefaultTableModel) t8.getModel();

        int ri = dtm.getRowCount();
        for (int i = 0; i < ri; i++) {

            int pnew = Integer.parseInt((String) t8.getValueAt(i, 1));

            String proname = (String) t8.getValueAt(i, 0);
            ...
            try {
                ...
                if (rs.next()) {
                    ...
                    DefaultTableModel model = (DefaultTableModel) t8.getModel();
                    model.setRowCount(0);
